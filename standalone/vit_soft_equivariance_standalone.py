#!/usr/bin/env python3
"""
Standalone script for applying soft equivariance filters to Vision Transformer (ViT).

All softeq dependencies are inlined — only requires:
    pip install torch transformers pillow

Usage:
    python vit_soft_equivariance_standalone.py
"""
...
# ============================================================
# INLINED: models/filtered_layers_vit.py
# ============================================================
...
# ============================================================
# Original vit_soft_equivariance.py main logic
# ============================================================

def main():
    print("=" * 60)
    print("Soft Equivariance for Vision Transformer (ViT)")
    print("=" * 60)
    ...
    if image is not None:
        ...
        for angle in [0, 90, 180, 270]:
            ...
            with torch.no_grad():
                vit_outputs = model.vit(**inputs, return_dict=True)
                cls_feat = vit_outputs.last_hidden_state[:, 0]
