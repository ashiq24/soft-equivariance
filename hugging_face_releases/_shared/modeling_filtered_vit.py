"""HuggingFace remote-code wrapper for filtered ViT classification."""
...
class FilteredVitBasePatch16_224(PreTrainedModel):
    ...
    def __init__(self, config: SoftEqConfig) -> None:
        ...
        model_kwargs["type"] = "filtered_vit"
        self.model = create_filtered_vit(model_kwargs)
